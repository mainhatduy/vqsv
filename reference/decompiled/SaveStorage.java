...
/**
 * SaveStorage - Persistent RecordStore (RMS) storage manager for player save files and settings.
 */
public final class SaveStorage {
    ...
    public SaveStorage(String text) {
        this.c = text;
        if (this.c() == 0) {
            this.a(1);
            return;
    ...
    private void a(int n2) {
        try {
            ...
            for (int i = 0; i <= 0; ++i) {
                int n3 = byteArray.length;
                byte[] byteArray2 = byteArray;
                SaveStorage ar2 = this;
                ar2.a(ar2.f, byteArray2, 0, n3, 1);
            }
            return;
        }
    ...
    public final byte[] a() {
        ...
        byte[] byteArray = new byte[((byte[])object).length - 1];
        System.arraycopy(object, 1, byteArray, 0, byteArray.length);
        this.d();
        return byteArray;
    }

    public final void a(ByteArrayOutputStream object) {
        byte[] byteArray = ((ByteArrayOutputStream)object).toByteArray();
        if (!this.a) {
            object = new byte[byteArray.length + 1];
            System.arraycopy(byteArray, 0, object, 1, byteArray.length);
            object[0] = true;
    ...
    private byte[] a(int n2, byte[] byteArray, int n3, int n4, int n5) {
        try {
            if (n5 == 7 || n5 == 6) {
                if (this.d != null) {
            ...
            switch (n5) {
                ...
                case 1: {
                    this.d.addRecord(byteArray, 0, n4);
                    break;
                }
                case 2: {
                ...
                case 4: {
                    this.d.setRecord(n2, byteArray, 0, n4);
                }
            }
        }
        catch (Exception exception) {
    ...
    public final void a(byte[] byteArray) {
        ...
        try {
            ...
            ((OutputStream)dataOutputStream).write(byteArray);
