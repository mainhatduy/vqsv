...
/**
 * SmsSender - Asynchronous background SMS dispatching thread for telecom billing.
 */
...
implements Runnable {
    ...
    public SmsSender(TimerCallback x2) {
        Class.forName("javax.wireless.messaging.Message");
        this.a = x2;
        if (this.c == null) {
            this.c = new Thread(this);
    ...
    public final synchronized void a(String text) {
        this.b = text;
    }
