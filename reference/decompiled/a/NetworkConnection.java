...
/**
 * NetworkConnection - Low-level HTTP socket connection handler for SMS/billing gateway.
 */
public final class NetworkConnection {
    ...
    public NetworkConnection(SessionData i2) {
        this.a = i2;
    }
    ...
    public final PropertyRef e(int n2) {
        PropertyRef j2;
        int n3 = this.d + n2;
        SessionData i2 = this.a;
        int n4 = i2.d.size();
        while (--n4 >= 0) {
            j2 = (PropertyRef)i2.d.elementAt(n4);
            if (j2.b == n3) {
                return j2;
            }
            if (j2.b < n3) break;
